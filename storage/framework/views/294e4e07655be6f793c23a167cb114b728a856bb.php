            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.update')); ?> <?php echo e(trans('file.return')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        <?php echo Form::open(['route' => ['return-sale.update', $ezpos_return_data->id], 'method' => 'put', 'files' => true, 'id' => 'payment-form']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="date" name="date" value="<?php echo e(date('d-m-Y', strtotime($ezpos_return_data->date))); ?>" class="form-control" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.reference')); ?> No</strong></label>
                                            <p><strong><?php echo e($ezpos_return_data->reference_no); ?></strong></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="store_id_hidden" value="<?php echo e($ezpos_return_data->store_id); ?>" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="customer_id_hidden" value="<?php echo e($ezpos_return_data->customer_id); ?>" />
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $ezpos_product_return_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_return): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                    <?php 
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><input type="number" class="form-control qty" name="qty[]" value="<?php echo e($product_return->qty); ?>" step="any" required/></td>
                                                        ...
                                                        <input type="hidden" class="sale-unit" name="sale_unit[]" value="<?php echo e($product_return->unit); ?>"/>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total-qty"><?php echo e($ezpos_return_data->total_qty); ?></th>
                                                    <th></th>
                                                    <th id="total-discount"><?php echo e(number_format((float)$ezpos_return_data->total_discount, 2, '.', '')); ?></th>
                                                    <th id="total-tax"><?php echo e(number_format((float)$ezpos_return_data->total_tax, 2, '.', '')); ?></th>
                                                    <th id="total"><?php echo e(number_format((float)$ezpos_return_data->total_price, 2, '.', '')); ?></th>
                                                    <th><i class="fa fa-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_qty" value="<?php echo e($ezpos_return_data->total_qty); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount" value="<?php echo e($ezpos_return_data->total_discount); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_tax" value="<?php echo e($ezpos_return_data->total_tax); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_price" value="<?php echo e($ezpos_return_data->total_price); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="item" value="<?php echo e($ezpos_return_data->item); ?>" />
                                            <input type="hidden" name="order_tax" value="<?php echo e($ezpos_return_data->order_tax); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="grand_total" value="<?php echo e($ezpos_return_data->grand_total); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="hidden" name="order_tax_rate_hidden" value="<?php echo e($ezpos_return_data->order_tax_rate); ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.return')); ?> <?php echo e(trans('file.Note')); ?></strong></label>
                                            <textarea rows="5" class="form-control" name="return_note" ><?php echo e($ezpos_return_data->return_note); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.Staff')); ?> <?php echo e(trans('file.Note')); ?></strong></label>
                                            <textarea rows="5" class="form-control" name="staff_note"><?php echo e($ezpos_return_data->staff_note); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
