...
<section>
    <h4 class="text-center"><?php echo e(trans('file.Payment')); ?> <?php echo e(trans('file.Report')); ?></h4>
    ...
    <div class="table-responsive">
        <table id="report-table" class="table table-hover">
            ...
            <tbody>
                <?php $__currentLoopData = $ezpos_payment_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php 
