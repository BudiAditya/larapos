                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="<?php echo e(route('sale.invoice', ['id' => $sale->id])); ?>" class="btn btn-link"><i class="fa fa-copy"></i> <?php echo e(trans('file.Generate')); ?> <?php echo e(trans('file.Invoice')); ?></a>
                                </li>
                                <li>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;"><?php echo e(trans('file.Sale')); ?> <?php echo e(trans('file.Details')); ?></i>
                </div>
            </div>
        </div>
