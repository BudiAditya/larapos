                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <?php if(in_array("products-edit", $all_permission)): ?>
                                  <li>
                                    <a href="<?php echo e(route('products.edit', ['id' => $product->id])); ?>" class="btn btn-link"><i class="fa fa-edit"></i> Edit</a>
                                  </li>
                                <?php endif; ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
           <p><?php echo e(trans('file.The correct column order is')); ?> (name*, image, code*, type*, brand, category*, unit, cost*, price*, product_details) <?php echo e(trans('file.and you must follow this')); ?>.</p>
