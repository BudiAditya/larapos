            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.update')); ?> <?php echo e(trans('file.Purchase')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        <?php echo Form::open(['route' => ['purchase.update', $ezpos_purchase_data->id], 'method' => 'put', 'files' => true, 'id' => 'purchase-form']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="date" name="date" value="<?php echo e(date('d-m-Y', strtotime($ezpos_purchase_data->date))); ?>" class="form-control" required />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.reference')); ?> No</strong></label>
                                            <p><strong><?php echo e($ezpos_purchase_data->reference_no); ?></strong> </p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.Store')); ?> *</strong></label>
                                            <input type="hidden" name="store_id_hidden" value="<?php echo e($ezpos_purchase_data->store_id); ?>" />
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="supplier_id_hidden" value="<?php echo e($ezpos_purchase_data->supplier_id); ?>" />
                                	...
                                	<div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="status_hidden" value="<?php echo e($ezpos_purchase_data->status); ?>">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $ezpos_product_purchase_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                    <?php 
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="hidden" class="purchase-unit" name="purchase_unit[]" value="<?php echo e($product_purchase->unit); ?>"/>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total-qty"><?php echo e($ezpos_purchase_data->total_qty); ?></th>
                                                    <th></th>
                                                    <th class="recieved-product-qty d-none"></th>
                                                    <th id="total-discount"><?php echo e(number_format((float)$ezpos_purchase_data->total_discount, 2, '.', '')); ?></th>
                                                    <th id="total-tax"><?php echo e(number_format((float)$ezpos_purchase_data->total_tax, 2, '.', '')); ?></th>
                                                    <th id="total"><?php echo e(number_format((float)$ezpos_purchase_data->total_cost, 2, '.', '')); ?></th>
                                                    <th><i class="fa fa-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_qty" value="<?php echo e($ezpos_purchase_data->total_qty); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount" value="<?php echo e($ezpos_purchase_data->total_discount); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_tax" value="<?php echo e($ezpos_purchase_data->total_tax); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_cost" value="<?php echo e($ezpos_purchase_data->total_cost); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="item" value="<?php echo e($ezpos_purchase_data->item); ?>" />
                                            <input type="hidden" name="order_tax" value="<?php echo e($ezpos_purchase_data->order_tax); ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="grand_total" value="<?php echo e($ezpos_purchase_data->grand_total); ?>" />
                                            <input type="hidden" name="paid_amount" value="<?php echo e($ezpos_purchase_data->paid_amount); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="order_tax_rate_hidden" value="<?php echo e($ezpos_purchase_data->order_tax_rate); ?>">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order_discount" class="form-control" value="<?php echo e($ezpos_purchase_data->order_discount); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="shipping_cost" class="form-control" value="<?php echo e($ezpos_purchase_data->shipping_cost); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" name="note" ><?php echo e($ezpos_purchase_data->note); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
