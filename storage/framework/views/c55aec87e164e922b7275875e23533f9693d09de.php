...
<section>
    ...
    <div class="table-responsive">
        <table id="stock-count-table" class="table table-striped stock-count-list">
            ...
            <tbody>
                <?php $__currentLoopData = $ezpos_stock_count_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $stock_count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php 
                ...
                <tr>
                    ...
                    <td><?php echo e(date('d-m-Y', strtotime($stock_count->created_at->toDateString())) . ' '. $stock_count->created_at->toTimeString()); ?></td>
...
<script type="text/javascript">
    ...
    $('.final-report').on('click', function(){
        ...
        var htmltext = '<strong><?php echo e(trans("file.Date")); ?>: </strong>'+stock_count[0]+'<br><strong><?php echo e(trans("file.reference")); ?>: </strong>'+stock_count[1]+'<br><strong><?php echo e(trans("file.Store")); ?>: </strong>'+stock_count[2]+'<br><strong><?php echo e(trans("file.Type")); ?>: </strong>'+stock_count[3];
        if(stock_count[4])
