						...
						<div class="table-responsive">
						    <table class="table table-bordered table-striped reports-table">
						        ...
						        <tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
						                <?php if(in_array("return-purchase-index", $all_permission)): ?>
						        ...
						        <tr>
						            ...
						            <td colspan="5">
						                ...
						                <span style="display:inline-block;">
						                    <div class="text-center" aria-checked="false" aria-disabled="false">
					                    	<?php if(in_array("store-stock-report", $all_permission)): ?>
						                    ...
						                    <label for="store-stock-report" class="padding05"><?php echo e(trans('file.Store')); ?> <?php echo e(trans('file.Stock Chart')); ?> &nbsp;&nbsp;</label>
						                </span>
						                <span style="display:inline-block;">
						                    <div class="text-center" aria-checked="false" aria-disabled="false">
