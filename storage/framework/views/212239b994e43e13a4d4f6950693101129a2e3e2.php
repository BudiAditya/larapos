...
<section>
	<?php echo e(Form::open(['route' => ['report.dailyPurchaseByStore', $year, $month], 'method' => 'post', 'id' => 'report-form'])); ?>

	<input type="hidden" name="store_id_hidden" value="<?php echo e($store_id); ?>">
	<h4 class="text-center"><?php echo e(trans('file.Daily Purchase')); ?>s <?php echo e(trans('file.Report')); ?> &nbsp;&nbsp;
