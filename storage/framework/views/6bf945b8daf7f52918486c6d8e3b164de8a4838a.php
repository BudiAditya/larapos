            ...
            <div class="col-md-3">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><?php echo e(trans('file.Purchase Return')); ?>
                  ...
                  <div class="count-number sale-data"><?php echo e(number_format((float)$purchase_return, 2, '.', '')); ?></div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
...
<script type="text/javascript">
    ...
    function dashboardFilter(data){
        ...
        $('.profit-data').hide();
        $('.profit-data').html(parseFloat(data[3]).toFixed(2));
        $('.profit-data').show(500);

        $('.sale-data').hide();
        $('.sale-data').html(parseFloat(data[2]).toFixed(2));
        $('.sale-data').show(500);
    }
</script>
